    ...
    <div className={styles.page}>
      ...
      >
        ...
        <ul className={styles.navList}>
          ...
          <li
            className={`${styles.navItem} ${
              activeSection === "#districts" ? styles.active : ""
            }`}
          >
            <a
              href="#districts"
        ...
        <div className={styles.mainContainer}>
            ...
            <div className={styles.below}>
              <div className={styles.box}>
                ...
                <p className={styles.boxdescription}>
                  Your description goes here. This is where you can add more
                  details about the content of the box.
                </p>
              </div>
              <div className={styles.box}>
                <h3 className={styles.boxheading}>Your Heading</h3>
          ...
          <div className={styles.cardsContainer}>
            <Link href={"/Humidity"}>
              <div className={styles.card}>
                ...
                <p className={styles.smallDesc}>
                  Description for Humidity. Lorem ipsum dolor sit amet,
            ...
            <div className={styles.card}>
              ...
              <p className={styles.smallDesc}>
                Description for Temperature. Lorem ipsum dolor sit amet,
                consectetur adipisicing elit.
              </p>
              <div className={styles.goCorner}>
                <div className={styles.goArrow}>→</div>
            ...
            <div className={styles.card}>
              ...
              <p className={styles.smallDesc}>
                Description for Wind Speed. Lorem ipsum dolor sit amet,
                consectetur adipisicing elit.
              </p>
              <div className={styles.goCorner}>
                <div className={styles.goArrow}>→</div>
            ...
            <div className={styles.card}>
              ...
              <p className={styles.smallDesc}>
                Description for Dryness. Lorem ipsum dolor sit amet, consectetur
                adipisicing elit.
              </p>
              <div className={styles.goCorner}>
                <div className={styles.goArrow}>→</div>
            ...
            <div className={styles.card}>
              ...
              <p className={styles.smallDesc}>
                Description for Precipitation. Lorem ipsum dolor sit amet,
                consectetur adipisicing elit.
              </p>
              <div className={styles.goCorner}>
                <div className={styles.goArrow}>→</div>
            ...
            <div className={styles.card}>
              ...
              <p className={styles.smallDesc}>
                Description for Visibility. Lorem ipsum dolor sit amet,
                consectetur adipisicing elit.
              </p>
              <div className={styles.goCorner}>
                <div className={styles.goArrow}>→</div>
